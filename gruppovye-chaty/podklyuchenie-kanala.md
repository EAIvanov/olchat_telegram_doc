...
Чтобы ответить на комментарий пользователя, используйте кнопку "Цитировать сообщение" в открытой линии Битрикс24.
{% endstep %}
...
При этом, в случае, когда вы ведете переписку из Битрикс24 в чате обсуждений, ваши ответы на комментарии будут виды только в чате обсуждения. В комментариях под постом в основном канале данные ответы не отобразятся.
