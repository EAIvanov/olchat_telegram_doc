...
В случае, когда произошла смена типа группы, в приложении OLChat Telegram будет дублирование групп. Написать в старую группу больше не получится. Используйте для работы ту группу, которая имеет тип "Супергруппа" и её ID начинается с "100...".
