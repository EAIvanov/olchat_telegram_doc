...
В случае, когда произошла смена типа группы, в приложении Олчат Telegram будет дублирование групп. Написать в старую группу больше не получится - кнопки "Открыть чат" не будет. Используйте для работы ту группу, которая имеет тип "Супергруппа" и её ID начинается с "100...".
...
1 - Группа; 2 - Супергруппа; 3 - Канал.
