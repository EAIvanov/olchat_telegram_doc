...
{% hint style="info" %}
Если вы отправляете сообщение через приложение в первый раз после подключения интеграции, приложение может открываться не сразу, а спустя некоторое время. Во время открытия приложения вы увидите уведомление «Идёт загрузка приложения \[Олчат] Telegram». Связано это с синхронизацией ваших контактов Telegram с нашей системой. Рекомендуем перезайти в приложение через 3-5 минут.
{% endhint %}
...
В выпадающем списке указаны все найденные аккаунты Telegram. Поиск аккаунтов производится в полях **Телефон, Мессенджер** и **Сайт** в лиде или привязанной к сделке сущности (контакте, компании). Подробнее о том, как правильно записывать контактные данные клиента в карточку CRM (системы управления взаимоотношениями с клиентами) описано в статье [osobennosti-zapisi-kontaktnykh-dannykh-klienta-v-kartochke-crm.md](osobennosti-zapisi-kontaktnykh-dannykh-klienta-v-kartochke-crm.md "mention").
...
**Способ публикации в открытой линии —** доступны варианты:&#x20;

* **исходящим в ОЛ;**&#x20;
* **входящим сообщением в ОЛ;**
* **без публикации в ОЛ.**&#x20;
...
Иногда при попытке отправить клиенту сообщение через приложение может появиться уведомление: «У клиента нет Telegram-аккаунта или он скрыл номер телефона в настройках конфиденциальности».

<figure><img src="../.gitbook/assets/image (1017).png" alt=""><figcaption></figcaption></figure>

**Это уведомление может возникать по одной из следующих причин:**

* у клиента действительно отсутствует аккаунт Telegram;
* номер телефона скрыт в настройках конфиденциальности Telegram;
* сообщение отправляется клиенту впервые, и данные о контакте ещё не успели загрузиться в систему.
...
В случае, когда после ожидания уведомление продолжает отображаться, это означает, что номер телефона скрыт настройками конфиденциальности на стороне клиента (либо у клиента действительно нет Telegram-аккаунта).
