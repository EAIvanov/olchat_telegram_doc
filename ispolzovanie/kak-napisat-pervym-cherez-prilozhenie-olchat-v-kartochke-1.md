...
<figure><img src="../.gitbook/assets/2026-02-27_13-58-24.png" alt=""><figcaption></figcaption></figure>
...
При выборе способа **Входящее** сообщение будет опубликовано в чате как будто от лица клиента, но с пометкой «OLChat», показывающей, что это сообщение было написано методом публикации **Входящим сообщением в ОЛ.**
...
При выборе режима **Не отправлять** сообщение не будет опубликовано в чате Открытой линии.
