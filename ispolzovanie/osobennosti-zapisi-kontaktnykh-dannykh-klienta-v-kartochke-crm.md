...
2.  **Мессенджер (IM).** В поле в виде специальной формы записи хранится идентификатор пользователя открытой линии, ID (идентификатор) чата пользователя Telegram и другие параметры. Данный идентификатор создаётся автоматически. Чтобы он работал корректно, его нельзя изменять или добавлять самостоятельно!<br>
