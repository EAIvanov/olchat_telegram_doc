...
{% hint style="info" %}
По умолчанию виджет «Чаты Telegram» при открытии карточки сущности отображается в скрытом виде с кнопкой «Написать в Telegram».
{% endhint %}
...
<figure><img src="../../.gitbook/assets/Снимок (1).JPG" alt=""><figcaption></figcaption></figure>
...
Если диалог с клиентом уже начат и чат был создан ранее, отобразится кнопка «Открыть чат». После нажатия на неё вы перейдёте в существующий чат с клиентом.

<figure><img src="../../.gitbook/assets/Снимок12.JPG" alt=""><figcaption></figcaption></figure>
...
Если чек-бокс «Создавать Дело в таймлайне» активирован, после отправки сообщения в таймлайне карточки создастся дело с информацией о содержании сообщения.
...
**Что делать при ошибке «Нет данных авторизации от Битрикс24»?** Возможные причины:
