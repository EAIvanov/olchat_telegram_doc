...
{% hint style="info" %}
По умолчанию виджет «OLChat:Telegram» при открытии карточки сущности отображается в скрытом виде с кнопкой «Написать в Telegram».
{% endhint %}
...
<figure><img src="../../.gitbook/assets/Снимок (1) (1).JPG" alt=""><figcaption></figcaption></figure>
