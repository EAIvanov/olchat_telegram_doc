# Виджет в карточке CRM и Смарт-процессах
...
Как написать из виджета, можно узнать [здесь](olchat-telegram.md). Подробнее о работе с приложением в карточке ознакомьтесь в статье [«Отправка сообщений из приложения в карточке»](https://tg.docs.olchat.io/ispolzovanie/kak-napisat-pervym-cherez-prilozhenie-olchat-v-kartochke).
