...
3. В зависимости от выбранного типа идентификатора, в поле **Идентификатор чата** укажите **Номер телефона, ID чата** или **username,** куда будет отправлено сообщение.
   *   <sup>Если в поле</sup> <sup></sup><sup>**«Идентификатор чата»**</sup> <sup></sup><sup>вы выбираете вариант</sup> <sup></sup><sup>**«Номер телефона»**</sup><sup>, важно убедиться, что в настройках робота указано</sup> <sup></sup><sup>**корректное поле с номером телефона**</sup><sup>.</sup>
       ...
       <sup>Например, если в карточке клиента заполнено поле</sup> <sup></sup><sup>**«Мобильный телефон»**</sup><sup>, а в настройке робота в строке</sup> <sup></sup><sup>**«Номер телефона»**</sup> <sup></sup><sup>указана переменная</sup> <sup></sup><sup>**\{{Рабочий телефон\}}**</sup><sup>, робот</sup> <sup></sup><sup>**не сможет найти номер**</sup> <sup></sup><sup>— в результате сообщение</sup> <sup></sup><sup>**не будет отправлено**</sup><sup>.</sup>\ <sup>Чтобы робот корректно подставлял номер из</sup> <sup></sup><sup>**любого**</sup> <sup></sup><sup>заполненного телефонного поля, рекомендуем в строке</sup> <sup></sup><sup>**«Номер телефона»**</sup> <sup></sup><sup>выбрать переменную</sup> <sup></sup><sup>**\{{Телефон (текст)\}}**</sup><sup>.</sup>
