...
Для проверки присутствия пользователя в Telegram добавьте робота «\[Олчат: Telegram] Поиск пользователя в Telegram». Для этого перейдите в **Роботы ‒ Создать ‒ Выбор стадии ‒ Другие роботы ‒ \[Олчат: Telegram] Поиск пользователя в Telegram ‒ Добавить.**
...
3. В зависимости от выбранного типа идентификатора, в поле **Идентификатор чата** укажите **Номер телефона, ID чата** или **username (имя пользователя),** которые необходимо проверить на существование аккаунта в Telegram.
...
Для проверки присутствия пользователя в Telegram, добавьте действие «\[Олчат: Telegram] Поиск пользователя в Telegram».
