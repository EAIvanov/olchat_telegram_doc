...
Чтобы отправить файл, добавьте робота «\[OLChat: Telegram] Отправка файла». Для этого перейдите в **Роботы ‒ Создать ‒ Выбор стадии ‒ Другие роботы ‒ \[OLChat: Telegram] Отправка файла ‒ Добавить.**
