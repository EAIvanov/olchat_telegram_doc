...
2. Результат выполнения робота выводится в комментарий в таймлайне (хронологии) элемента.

Для начала добавим робота **«\[Олчат: Telegram] Отправка сообщения»** и выполним его настройку.
...
Выполним настройку робота. Результат выполнения предыдущего робота **«\[Олчат] Отправка сообщения»** содержится в дополнительных результатах отработанного робота в разделе Роботы — \[Олчат: Telegram] Отправка сообщения. Добавим значения **«Сообщение отправлено?»** и **«Описание ошибки».**
...
Вы можете усовершенствовать вашего робота вывода сообщения в комментарий и выводить комментарий только в том случае, когда роботу **\[Олчат: Telegram] Отправка сообщения** не удалось отправить сообщение или присутствуют ошибки при отправке.
