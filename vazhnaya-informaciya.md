...
5. У пользователя действительно нет Telegram, номер не зарегистрирован в приложении.

Во всех перечисленных случаях вы увидите подобное уведомление при попытке написать из Битрикс24:&#x20;
