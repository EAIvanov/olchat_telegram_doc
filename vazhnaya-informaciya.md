...
### **Ограничения на новые чаты. Почему не получается написать всем по номеру телефона?**

Ниже опишем основные причины, почему такое может произойти.

1. В отличие от WhatsApp, в Telegram номер телефона **не является обязательным** публичным идентификатором для всех пользователей. Это важный момент, который нужно учитывать при попытках написать клиенту по номеру. &#x20;
...
Разберем при каких настройках написать по номеру не получится. &#x20;
...
**Что можно сделать в такой ситуации?** Попробуйте, написать изначально с телефона (через мобильное приложение Telegram) - поскольку ограничения действуют чаще на уровне API (интрегации), но это не даёт 100% гарантии.
...
4. Ваш аккаунт заблокирован. Для предотвращения фишинга, спама и других видов злоупотреблений и нарушений Условий обслуживания Telegram, ваш аккаунт может быть ограничен от контактов с незнакомыми людьми - временно или навсегда.
...
{% hint style="success" %}
Важно! Новый аккаунт надо “прогревать” перед подключением. Первые несколько дней используйте аккаунт в обычном режиме (личные диалоги, подписка на каналы, реакции, комментарии). Избегайте резких всплесков: массового добавления контактов, массовых первых сообщений, одинаковых шаблонов. Подключайте OLChat, когда аккаунт уже выглядит “живым” (есть переписка, нормальная активность).
{% endhint %}



5. У пользователя действительно нет Telegram, номер не зарегистрирован в приложении.<br>

**Во всех вышеперечисленных случаях вы увидите подобное уведомление при попытке написать из Битрикс24:**&#x20;

{% hint style="danger" %}
У клиента нет Telegram-аккаунта или он скрыл номер телефона в настройках конфиденциальности
{% endhint %}
