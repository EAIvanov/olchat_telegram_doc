...
Настроим основные параметры открытой линии к которой подключен коннектор. Для этого перейдите в приложение Олчат Telegram в левом меню портала и напротив нужного коннектора нажмите на значок меню «•••». Выберите пункт «Настройки линии»:
...
{% hint style="info" %}
Открытые линии: [общие настройки Битрикс24](https://helpdesk.bitrix24.ru/open/2448369/).
{% endhint %}
