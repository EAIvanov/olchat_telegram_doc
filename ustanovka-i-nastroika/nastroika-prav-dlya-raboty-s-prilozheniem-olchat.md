...
{% hint style="warning" %}
Иногда возникает ситуация, когда сотрудника, установившего приложение OLChat, необходимо уволить с портала Битрикс24. В этом случае права перейдут другому назначенному на портале администратору.
{% endhint %}

В разделе **OLChat: Telegram — ⚙ Настройки — ОБЩИЕ** вы увидите пользователя, под чьими правами приложение работает в данный момент. Чтобы узнать, кто сейчас назначен администратором, нужно обратиться в службу поддержки.
