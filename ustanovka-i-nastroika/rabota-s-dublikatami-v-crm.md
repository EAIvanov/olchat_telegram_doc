...
{% hint style="warning" %}
На данный момент сам Битрикс24 поддерживает работу только с телефонами и электронными почтами. Другие идентификаторы, такие как username (имя пользователя) или ID (идентификатор) в Telegram, не распознаются системой и не могут быть сопоставлены с номерами телефонов. Но сейчас их данные идентификаторы можно записывать в другое поле.
