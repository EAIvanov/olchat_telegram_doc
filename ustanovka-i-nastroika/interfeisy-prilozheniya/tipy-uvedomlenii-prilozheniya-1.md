...
Приложение OLChat Telegram создаёт на вашем портале Битрикс24 специальный чат, в который приходят уведомления. Здесь можно получить оперативную информацию об изменении статуса авторизации, подключения, оплаты, о блокировке линии. Также здесь будут подсказки для настройки приложения.
...
1. На портале Битрикс24 в меню слева откройте раздел «Приложения» и выберите OLChat Telegram.
...
* OLChat Telegram предупредит об окончании тестового периода за 24 часа:&#x20;
