...
Шаблоны создаются и редактируются в отдельном приложении Олчат WhatsApp. Подробная инструкция по созданию, редактированию, категориям и переменным доступна [здесь](https://docs.olchat.io/capabilities/shablony-soobshenii).
...
* **Олчат — Чаты и Группы WhatsApp,** [как установить приложение](https://docs.olchat.io/ustanovka-i-nastroika/ustanovka-prilozheniya).&#x20;
