...
Для оплаты коннектора выполните следующие действия в приложении Олчат Telegram:

{% stepper %}
{% step %}
Перейдите в приложение Олчат Telegram и выберите пункт «Новый платёж».
...
{% step %}
В поле «Компания» нажмите «<img src="../.gitbook/assets/image (1029).png" alt="" data-size="line">», затем «+ Добавить компанию».
...
{% hint style="info" %}
Если данные компании изменились, выберите «Редактировать», чтобы внести актуальные данные.

Если необходимо полностью удалить данные о компании, воспользуйтесь кнопкой «Удалить».
{% endhint %}
{% endstep %}
...
Список открытых линий можно отсортировать по названию, а также оставшемуся сроку оплаты. Для этого нажмите <img src="../.gitbook/assets/image (1031).png" alt="" data-size="line"> рядом с наименованием столбца.&#x20;
...
{% step %}
#### Оплата коннектора Олчат Telegram завершена.
{% endstep %}
{% endstepper %}
